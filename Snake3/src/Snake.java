...
public class Snake  {
	...
	public static NormalFood normalFood = new NormalFood();
	public static RunningFood runningFood = new RunningFood();
  ...
  public static Point ptc(int x, int y) {
	  ...
	  p.x = x * 32 + Game.xCoordinate;
	  p.y = y * 32 + Game.yCoordinate;
